...
<body>
    ...
    <div class="profile-info">
        ...
        <ul class="nav nav-pills flex-column">
            ...
            <li class="nav-item">
                <a href="{{ route('stockin.view') }}" class="nav-link active"><i class="fa fa-arrow-down me-2"></i>Stock In</a>
            </li>
            <li class="nav-item">
    ...
    <div class="main-content">
        <div class="card mx-auto" style="max-width: 500px;">
            <div class="card-header">
                <h5 class="mb-0">Edit Stock In</h5>
            </div>
    ...
    <select name="product_id" id="product_id" class="form-select" required>
        ...
        @foreach ($products as $product)
            <option value="{{ $product->id }}" {{ $product->id == $stockin->product_id ? 'selected' : '' }}>
        ...
        @endforeach
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="quantity" id="quantity" class="form-control"
                               value="{{ old('quantity', $stockin->quantity) }}" min="1" required>
                    </div>

                    <div class="form-group">
                        <label for="price">Price (per unit)</label>
                        <input type="number" name="price" id="price" class="form-control" step="0.01"
                               value="{{ old('price', $stockin->price) }}" min="0" required>
                    </div>

                    <div class="d-flex justify-content-between mt-4">
                        <button type="submit" class="btn btn-primary"><i class="fa fa-save me-1"></i> Update</button>
                        <a href="{{ route('stockin.view') }}" class="btn btn-outline-primary"><i class="fa fa-eye me-1"></i> View Stock In</a>
                    </div>
                </form>
            </div>
        </div>
