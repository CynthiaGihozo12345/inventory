    ...
    <div class="main-content">
        <div class="card mx-auto" style="max-width: 900px;">
            <div class="card-header">
                <h5 class="mb-0">List of Stock out Records</h5>
...
@endif
            <div class="card-body">
                ...
                <table class="table table-bordered table-hover">
                    ...
                    <tr><th colspan="4" style="border: 0;"><a href="{{ route('stockout.form') }}" class="btn btn-primary btn-sm">ADD +</a></th></tr>
                        <tr>
                            <th>ID</th>
                            <th>Product ID</th>
                            <th>Quantity</th>
                        ...
                        @foreach($products as $p)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="{{route('stockout.edit',['stockout'=>$p])}}" class="btn btn-sm btn-warning me-1">Update</a>
                                    <form action="{{route('stockout.delete',['stockout'=>$p])}}" method="POST" class="d-inline">
                                        @csrf
                                        @method('DELETE')
